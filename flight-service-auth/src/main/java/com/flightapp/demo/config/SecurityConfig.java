...
public class SecurityConfig {
	...
	public SecurityWebFilterChain security(ServerHttpSecurity http) {
		return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
				.authorizeExchange(ex -> ex.pathMatchers("/auth/ping").permitAll().pathMatchers("/api/flight/internal/**").permitAll().pathMatchers("/api/seats/**").permitAll().anyExchange().authenticated())
